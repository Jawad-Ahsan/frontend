...
const OptionalQuestionnaire = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Optional questionnaire submitted:", formData);
    navigate('/home');
  };
        ...
        <div className="p-8 relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className={`p-6 rounded-lg ${darkMode ? 'bg-gray-600' : 'bg-gray-50'}`}>
              <h2 className="text-xl font-semibold mb-4">Social Determinants of Health</h2>
            ...
            {/* Mental Health */}
            <div className={`p-6 rounded-lg ${darkMode ? 'bg-gray-600' : 'bg-gray-50'}`}>
              <h2 className="text-xl font-semibold mb-4">Mental & Emotional Health</h2>
